...
- **Countdown Expiry:** Know exactly when your secret will vanish.  
- **Premium Design:** Dark, modern, professional UI with smooth animations.  
...
```bash
# Clone the repo
git clone https://github.com/<your-username>/one-time-msg.git
cd one-time-msg
